...
//
//        doThrow(new IOStorageException(s)).when(localFsProcessor).rollbackObject(x2.toDto(), USER.getDataSpace(), Instant.now());
//        doThrow(new IOStorageException(s)).when(localFsProcessor).delete(o2.toDto(), USER.getDataSpace(), Instant.now());
//
//        service.cleanUp(objects, Instant.now());
//
