...
public class ObjectWriteApi {
    ...
    public String saveAip(
        ...
        AipDto aipDto = new AipDto(userDetails.getDataSpace(), aipId, sip.getInputStream(), sipChecksum, aipXml.getInputStream(), aipXmlChecksum);
    ...
    @PostMapping(value = "/{aipId}/update", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    @ApiResponses(value = {
    ...
    public void remove(
            ...
            BadRequestException, NoLogicalStorageAttachedException, ReadOnlyStateException, JmsHealthCheckException {
        checkUUID(objId);
    ...
    public void delete(
            ...
            FailedStateException, SomeLogicalStoragesNotReachableException, BadRequestException, NoLogicalStorageAttachedException, ReadOnlyStateException, JmsHealthCheckException {
        checkUUID(objId);
    ...
    public void rollback(
            @Parameter(description = "object id", required = true) @PathVariable("objId") String objId) throws BadRequestException, SomeLogicalStoragesNotReachableException, NoLogicalStorageAttachedException, JmsHealthCheckException {
        checkUUID(objId);
    ...
    @RolesAllowed(Roles.READ_WRITE)
    public void forget(
            @Parameter(description = "object id", required = true) @PathVariable("objId") String objId) throws BadRequestException, SomeLogicalStoragesNotReachableException, NoLogicalStorageAttachedException, ForbiddenByConfigException, StorageException, StateException, JmsHealthCheckException {
    ...
    @DeleteMapping("/{aipId}/rollbackXml/{xmlVersion}")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "object successfully rolled back or rollback skipped because the object was not found"),
            @ApiResponse(responseCode = "400", description = "bad request, e.g. the specified id is not a valid UUID"),
    ...
    public void rollbackXml(
            @Parameter(description = "AIP id", required = true) @PathVariable("aipId") String aipId,
            @Parameter(description = "XML version", required = true) @PathVariable("xmlVersion") int xmlVersion) throws BadRequestException, SomeLogicalStoragesNotReachableException, NoLogicalStorageAttachedException, StateException, StorageException, JmsHealthCheckException {
        checkUUID(aipId);
        if (xmlVersion < 2) {
    ...
    @Operation(summary = "Deletes the latest AIP XML. Version set in the path variable must be the latest AIP XML of the AIP.",
            description = "If the AIP or XML does not exists, Archival storage silently skips the request- ")
    @DeleteMapping("/{aipId}/forgetXml/{xmlVersion}")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "object successfully forgotten or forget call skipped because the object was not found"),
            @ApiResponse(responseCode = "400", description = "bad request, e.g. the specified id is not a valid UUID"),
    ...
    public void forgetXml(
            @Parameter(description = "AIP id", required = true) @PathVariable("aipId") String aipId,
            @Parameter(description = "XML version", required = true) @PathVariable("xmlVersion") int xmlVersion) throws BadRequestException, SomeLogicalStoragesNotReachableException, NoLogicalStorageAttachedException, StateException, ForbiddenByConfigException, StorageException, JmsHealthCheckException {
        if (!forgetFeatureAllowed) {
            throw new ForbiddenByConfigException("forget feature not allowed");
        }
        checkUUID(aipId);
